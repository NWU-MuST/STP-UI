...
CKEDITOR.plugins.add( 'removemustformat', {
	// jscs:disable maximumLineLength
	lang: 'af,ar,bg,bn,bs,ca,cs,cy,da,de,el,en,en-au,en-ca,en-gb,eo,es,et,eu,fa,fi,fo,fr,fr-ca,gl,gu,he,hi,hr,hu,id,is,it,ja,ka,km,ko,ku,lt,lv,mk,mn,ms,nb,nl,no,pl,pt,pt-br,ro,ru,si,sk,sl,sq,sr,sr-latn,sv,th,tr,tt,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%
	// jscs:enable maximumLineLength
	//icons: this.path + 'icons/text_formatting.png', // %REMOVE_LINE_CORE%
	//hidpi: true, // %REMOVE_LINE_CORE%
	init: function( editor ) {
		editor.addCommand( 'removeMustFormat', CKEDITOR.plugins.removemustformat.commands.removemustformat );
		editor.ui.addButton && editor.ui.addButton( 'RemoveMustFormat', {
			label: editor.lang.removeformat.toolbar,
			command: 'removeMustFormat',
			toolbar: 'cleanup,10',
			icon: this.path + 'icons/text_formatting.png'
		} );
	}
} );

CKEDITOR.plugins.removemustformat = {
	commands: {
		removemustformat: {
 ...
 */
//CKEDITOR.config.removeFormatTags = 'b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var,conf';
CKEDITOR.config.removeFormatTags = 'conf';
/**
